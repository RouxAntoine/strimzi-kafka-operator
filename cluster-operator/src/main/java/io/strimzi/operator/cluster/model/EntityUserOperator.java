...
public class EntityUserOperator extends AbstractModel implements SupportsLogging {
    ...
    /**
     * Generates the User Operator Cluster Role Binding
     *
     * @param namespace Namespace where the User Operator is deployed
     *
     * @return  Cluster Role Binding for the User Operator
     */
    public ClusterRoleBinding generateClusterRoleBindingForClusterRole(String namespace) {
        ...
        return RbacUtils
                .createClusterRoleBinding(
                        KafkaResources.entityUserOperatorClusterRoleBinding(cluster),
                        roleRef,
                        List.of(subject),
                        labels,
                        templateRoleBinding
